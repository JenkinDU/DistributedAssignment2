...
//		}
	...
	private synchronized int getBookedCount(DFRS dfrs, int type, int departure) {
	...
	protected void startBookTest(DFRS dfrs, int th, int departure, boolean show) {
...
//					System.out.println(server[departure]+"[B]-"+th+":"+success.content);
	...
	protected void startTransferTest(DFRS dfrs, int th, int departure) {
		Random r = new Random(System.currentTimeMillis());
		new Thread(new Runnable() {
...
//					System.out.println(server[departure]+"[T]-"+th+":"+result.content);
	...
	protected void startEditTest(DFRS dfrs, int th, int departure, boolean show) {
		Random r = new Random(System.currentTimeMillis());
		new Thread(new Runnable() {
...
//					System.out.println(server[departure]+"[E]-"+th+":"+result.content);
	...
	protected DFRS initConnection(int i, String port) {
		try {
